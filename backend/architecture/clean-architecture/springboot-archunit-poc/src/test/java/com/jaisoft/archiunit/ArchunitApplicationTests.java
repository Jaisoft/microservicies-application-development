...
class ArchunitApplicationTests {
    ...
    public void setup() {
        importedClasses = new ClassFileImporter()
                ...
                .importPackages("com.jaisoft.archiunit");
    }
    ...
    void servicesAndRepositoriesShouldNotDependOnWebLayer() {
        ...
        noClasses()
                .that().resideInAnyPackage("com.jaisoft.archiunit.service..")
                .or().resideInAnyPackage("com.jaisoft.archiunit.repository..")
                .should()
                .dependOnClassesThat()
                .resideInAnyPackage("com.jaisoft.archiunit.controller..")
